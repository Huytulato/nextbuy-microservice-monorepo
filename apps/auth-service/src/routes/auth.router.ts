...
import { userRegistration, verifyUser, loginUser, forgotPassword, resetPassword, verifyUserForgotPasswordOtp, refreshUserTokens, getUser, verifySeller, registerSeller, createSellerShop } from "../controller/auth.controller"; // import the user registration controller function to handle user registration logic
