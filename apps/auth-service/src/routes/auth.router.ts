...
import { userRegistration, verifyUser, loginUser, forgotPassword, resetPassword, verifyUserForgotPasswordOtp } from "../controller/auth.controller"; // import the user registration controller function to handle user registration logic
